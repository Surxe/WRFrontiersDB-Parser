...
from utils import init_params, Params, clear_dir, run_process, wait_for_process_by_name, wait_for_process_ready_for_injection, terminate_process_by_name, terminate_process_object, is_admin
...
def main(params=None):
    ...
    if not is_admin():
        logger.warning("Not running as administrator - DLL injection may fail")
    else:
    ...
    try:
        ...
        wait_for_process_ready_for_injection(game_process_name, initialization_time=20, timeout=180)  # 3 minutes total timeout
